    ...
    return (
      <section className="c-article-content">
        ...
        <div>
          ...
          <div style={overlay}>
            <div style={{background: '#fff', position: 'relative', maxWidth: 900, minWidth: 200, minHeight: 200, margin: '0 auto'}}>
              ...
              <ul className='o-list--arrows'>
                ...
                {this.state.wikiResponse && this.state.wikiResponse.map(word => <li><strong>{word.headword}</strong>: {word['first_two_sentences']}</li>)}
                </ul>
              </ul>
            </div>
          </div>
