...
var TopicMenu = function (_Component) {
  ...
  _createClass(TopicMenu, [{
    ...
    key: 'handleMouseOver',
    value: function handleMouseOver(topicId) {
      if (this.closeCallback) {
        clearTimeout(this.closeCallback);
    ...
    value: function handleMouseLeave() {
      ...
      this.closeCallback = setTimeout(function () {
        _this2.setState({ expandedTopicId: undefined });
      }, this.props.delay);
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          topics.map(function (topic) {
            return _react2.default.createElement(
              'li',
              _extends({}, classes('topic-item', topic.id === expandedTopicId && 'active'), { onMouseOver: function onMouseOver() {
                  return _this3.handleMouseOver(topic.id);
                }, key: topic.id }),
              _react2.default.createElement(
                _SafeLink2.default,
                _extends({}, classes('link'), { onClick: closeMenu, to: toTopic(topic.id) }),
                topic.name
              )
            );
          })
