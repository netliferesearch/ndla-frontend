...
var mclasses = new _reactBemHelper2.default({
  name: 'resources-menu',
  prefix: 'c-'
});
...
var ResourceSubsetList = function (_Component) {
  ...
  _createClass(ResourceSubsetList, [{
    ...
    value: function handleScroll() {
      var containerTop = document.getElementsByClassName('c-resources')[0].offsetTop;
      var element = document.getElementsByClassName('c-resources-menu')[0];
      var elemTop = element.offsetTop;
      var scrollTop = this.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0; // Cover all browsers
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          mclasses(),
          resourceGroups.map(function (group) {
            return _react2.default.createElement(
              'li',
              _extends({ key: (0, _ndlaUtil.uuid)() }, mclasses('item', [group.color])),
              _react2.default.createElement(
                'a',
                { onClick: function onClick() {
                    return _this2.setState({ focusTitle: group.title });
                  }, href: '#' + group.title },
                group.title
              )
            );
        ...
        _react2.default.createElement(
          ...
          resourceGroups.map(function (group, i) {
            return _react2.default.createElement(
              ...
              group.tags ? group.tags.map(function (tags, o) {
                return _react2.default.createElement(
                  _SafeLink2.default,
                  _extends({ key: o }, classes('tag'), { to: toResourceTab(i) }),
                  tags
                );
              }) : null,
...
ResourceSubsetList.propTypes = {
  ...
  toResourceTab: _react.PropTypes.func.isRequired,
  resourceGroups: _react.PropTypes.arrayOf(_react.PropTypes.shape({
    title: _react.PropTypes.string.isRequired,
    description: _react.PropTypes.string.isRequired,
    viewAllLinkTitle: _react.PropTypes.string.isRequired,
