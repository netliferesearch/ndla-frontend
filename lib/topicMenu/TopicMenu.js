  ...
  _createClass(TopicMenu, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          subjectId = _props.subjectId,
          toSubject = _props.toSubject,
      ...
      return _react2.default.createElement(
        'div',
        classes('dropdown', null, 'o-wrapper u-1/1'),
...
TopicMenu.propTypes = {
  topics: _propTypes2.default.arrayOf(_shapes.TopicShape).isRequired,
  toTopic: _propTypes2.default.func.isRequired,
  toSubject: _propTypes2.default.string,
