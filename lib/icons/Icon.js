...
var _LicenseCopy = require('./LicenseCopy');

var _LicenseCopy2 = _interopRequireDefault(_LicenseCopy);
...
function Icon(props) {
  ...
  return (0, _react.createElement)(icon, { className: (0, _classnames2.default)('icon', rest.className) });
}
...
Icon.LicenseCopy = function (props) {
  return _react2.default.createElement(Icon, _extends({}, props, { icon: _LicenseCopy2.default }));
};
