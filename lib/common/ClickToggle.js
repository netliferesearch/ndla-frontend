  ...
  _createClass(ClickToggle, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        Component,
        rest,
        isOpen ? _react2.default.createElement(_Button2.default, { stripped: true, className: 'o-overlay', onClick: function onClick() {
            return _this2.setState({ isOpen: false });
          } }) : null,
        _react2.default.createElement(
          _Button2.default,
          { stripped: true, className: buttonClassName, onClick: this.handleClick },
          title
        ),
