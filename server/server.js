...
app.use((req, res, next) => {
  ...
  res.setHeader(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.herokuapp.com http://localhost:3000 http://localhost:3100 https://*.ndla.no https://players.brightcove.net https://www.nrk.no https://www.googletagmanager.com https://www.google-analytics.com https://www.youtube.com https://s.ytimg.com https://cdn.auth0.com; style-src 'self' 'unsafe-inline' 'unsafe-eval' https://fonts.googleapis.com https://fonts.gstatic.com; font-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com; connect-src 'self' https://*.herokuapp.com http://localhost:3000 http://localhost:3100 https://*.ndla.no https://logs-01.loggly.com; img-src 'self' https://*.herokuapp.com http://localhost:3000 http://localhost:3100 https://*.ndla.no https://www.google-analytics.com https://stats.g.doubleclick.net data: ;",
  );
  next();
});
